...
class TheMillSystem {
    ...
    executeCSGCut() {
        ...
        try {
            ...
            // Perform CSG cutting with proper piece separation
...
// Fix for bevel control degree labels - 90 at top, 0 on both sides
    ...
    switchToBladeProfileView() {
        ...
        if (this.tableSurface) {
            ...
            console.log("Table surface visibility:", this.tableSurface.isVisible, "Position:", this.tableSurface.position);
            this.tableSurface.renderingGroupId = 0; // Ensure proper rendering order
        }
        // Hide transform toolbar in B view (not needed)
        const toolbar = document.getElementById("mill-transform-toolbar");
        if (toolbar) toolbar.style.display = "none";
        console.log('Switched to LEFT side view (blade profile)');
        
        // Enable simple left/right dragging in B view
