...
export class RouterBitSystem {
    ...
    createUniversalCuttingTool(edge, routerBitMesh, scale, isImported) {
        ...
        if (isImported) {
            // For imported bits: use reasonable scale for cutting - not too large
            // Original imported size is ~0.002 units, scale to reasonable router bit size
            const imperialScale = 100; // Much smaller scale for better CSG stability
