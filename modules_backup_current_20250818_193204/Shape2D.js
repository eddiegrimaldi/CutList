...
export class Shape2D {
    ...
    createFillMaterial(name) {
        ...
        fillMaterial.alpha = 1.0; // Solid fill
        return fillMaterial;
    }
    ...
    getRectangleCorners(start, end) {
        ...
        if (this.sketchSystem && this.sketchSystem.sketchRight && this.sketchSystem.sketchUp) {
            ...
            // to ensure we always get a valid rectangle regardless of drag direction
            ...
            const corners = [
                start.add(this.sketchSystem.sketchRight.scale(minRight)).add(this.sketchSystem.sketchUp.scale(minUp)),     // Bottom-left
                start.add(this.sketchSystem.sketchRight.scale(maxRight)).add(this.sketchSystem.sketchUp.scale(minUp)),     // Bottom-right
                start.add(this.sketchSystem.sketchRight.scale(maxRight)).add(this.sketchSystem.sketchUp.scale(maxUp)),     // Top-right
                start.add(this.sketchSystem.sketchRight.scale(minRight)).add(this.sketchSystem.sketchUp.scale(maxUp))      // Top-left
            ];
