// src/modules/extrusionGizmo.js - v20250704_ULTRA_MEGA_MASSIVE FACE EXTRUSION INTEGRATION


// Report version to the global version reporter
const reportVersion = () => {
    if (window.VersionReporter) {
        window.VersionReporter.report('extrusionGizmo.js', 'v20250704_ULTRA_MEGA_MASSIVE', 'success');
        return true;
    }
    return false;
};
...
export default class ExtrusionGizmo {
    ...
    _updateGizmoPosition(extrusionAmount) {
        ...
        const gizmoOffset = faceNormal.scale(25.0);  // ULTRA MEGA MASSIVE: Keep gizmo 25 units off the face
    ...
    _createGizmoVisuals() {
        ...
        // MASTER - ULTRA MEGA MASSIVE GIZMO - IMPOSSIBLE TO MISS!
        const shaft = BABYLON.MeshBuilder.CreateCylinder("gizmoShaft", {
            diameter: 5.0,  // ULTRA MEGA MASSIVE: was 2.0
            height: 30.0    // ULTRA MEGA MASSIVE: was 15.0
        }, this.scene);
        shaft.parent = this.gizmoContainer;
        shaft.position.y = 15.0;  // ULTRA MEGA MASSIVE: was 7.5
        shaft.material = this._gizmoMaterial;
        shaft.isPickable = true;
        shaft.name = "extrusionGizmo_shaft";
        
        // MASTER - ULTRA MEGA MASSIVE CONE - CANNOT BE MISSED!
        const topCone = BABYLON.MeshBuilder.CreateCylinder("gizmoCone", {
            diameterTop: 0,
            diameterBottom: 10.0,  // ULTRA MEGA MASSIVE: was 4.0
            height: 12.0           // ULTRA MEGA MASSIVE: was 6.0
        }, this.scene);
        topCone.parent = this.gizmoContainer;
        topCone.position.y = 36.0;  // ULTRA MEGA MASSIVE: was 18.0
    ...
    show() {
        ...
        if (this.clickInfo && this.clickInfo.hit && this.clickInfo.pickedPoint) {
            ...
            // MASTER - ULTRA MEGA MASSIVE OFFSET - GIZMO FAR FROM SURFACE!
            gizmoPosition = this.clickInfo.pickedPoint.add(faceNormal.scale(25.0));  // ULTRA MEGA MASSIVE: was 10.0
        ...
        const gizmoOffset = 15.0; // ULTRA MEGA MASSIVE: Distance above the extruded surface
