...
<body>
    ...
    <div id="context-menu" class="context-menu" style="display: none;">
        ...
        <div class="context-menu-item" id="context-send-to-mill">
            <span class="context-icon">⚙</span>
    ...
    <script>
            ...
            getProjectData() {
                ...
                const preservedWorkBenchParts = (drawingWorld.workBenchParts || []).map(part => {
                    ...
                    const partCopy = {
                        ...
                        materialId: part.materialId || (part.material ? part.material.id : null),
                        materialName: part.materialName || (part.material ? part.material.name : null),
                        grade: part.grade,
                        grain: part.grain,
        ...
        const ContextMenuSystem = {
            ...
            setupEventListeners() {
                ...
                document.getElementById('context-send-to-mill').addEventListener('click', () => {
                    this.sendToMill();
                    this.hideContextMenu();
                });
